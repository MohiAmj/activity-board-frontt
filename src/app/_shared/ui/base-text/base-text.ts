...
export class BaseText {
  ...
  typeToClassMap: Record<TypographyType, string> = {
    ...
    display3: 'font-extrabold text-7xl',
    display4: 'font-extrabold text-6xl',
    display5: 'font-extrabold text-5xl',
    display6: 'font-extrabold text-4xl',
    display7: 'font-extrabold text-3xl',
    header1: 'font-bold text-4xl',
    header2: 'font-bold text-3xl',
    header3: 'font-bold text-2xl',
